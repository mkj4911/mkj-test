<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-black">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.sales.index')" :active="request()->routeIs('admin.sales.index')">
                        販売管理
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.sales.index')" :active="request()->routeIs('admin.sales.index')">
                販売管理
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.management.index')" :active="request()->routeIs('admin.management.index')">
                商品管理
            </x-responsive-nav-link>
